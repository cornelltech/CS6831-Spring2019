...
\newcommand{\cDom}{\overline{\mathsl{Dom}}}
\newcommand{\Range}{\mathsl{Rng}}
\newcommand{\Rng}{\Range}
\newcommand{\cRng}{\overline{\Range}}
\newcommand{\DomP}{\mathsl{Dom_P}}
\newcommand{\RngP}{\mathsl{Rng_P}}
\newcommand{\Domprog}{\mathsl{Dom_2}}
...
\newcommand{\inv}{^{-1}}
 ...
 \newcommand{\ExpPRP}[2]{\mathbf{Exp}^{\mathrm{prp}}_{#1}(#2)}
\newcommand{\AdvSPRP}[2]{\Adv^{\mathrm{sprp}}_{#1}(#2)}
...
\newcommand{\notecolor}{blue}
\newcommand{\paulnotecolor}{red}
\newcommand{\ydnotecolor}{purple}
\newcommand{\joannenotecolor}{green}
...
\newcommand{\pgnote}[1]{\ifnum\authnotes=1\refstepcounter{mynote}{\bf \textcolor{\paulnotecolor}{$\ll$PAG~\thenote: {\sf #1}$\gg$}}\fi}
\newcommand{\jwnote}[1]{\ifnum\authnotes=1\refstepcounter{mynote}{\bf \textcolor{\joannenotecolor}{$\ll$Joanne~\thenote: {\sf #1}$\gg$}}\fi}
\newcommand{\ydnote}[1]{\ifnum\authnotes=1\refstepcounter{mynote}{\bf \textcolor{\ydnotecolor}{$\ll$Yevgeniy~\thenote: {\sf #1}$\gg$}}\fi}
\newcommand{\tsnote}[1]{\ifnum\authnotes=1\refstepcounter{mynote}{\bf \textcolor{\tsnotecolor}{$\ll$TS~\thenote: {\sf #1}$\gg$}}\fi}
...
\newcommand{\TweakE}{\tilde{E}}
\newcommand{\TweakD}{\tilde{D}}
