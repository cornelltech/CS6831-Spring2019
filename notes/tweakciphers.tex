...
\caption{Real and ideal games for tweakable pseudorandom permutation and strong tweakable pseudorandom permutation security of a tweakable block cipher $\tbc = (\tbce,\tbcd)$}
\label{fig:tprp}
\end{figure}
...
LRW construction requires 2 block cipher calls per msg block... can we do better? Yes, but first we must briefly introduce finite fields.
