...
One way to construct a multi-round Feistel network is by feeding the outputs of the previous round as inputs to the next round, and where each round is keyed with a different unique key.
